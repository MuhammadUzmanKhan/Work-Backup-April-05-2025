...
import IntroductionOfYouTubeDownloader from "@/app/components/Introductions/IntroductionOfYouTubeDownloader";
import WorkingOfYouTubeDownloader from "@/app/components/Working/WorkingOfYouTubeDowloader";
import YouTubeDownloaderServiceCard from "@/app/components/ServicesCard/YouTubeDownloaderServiceCard";
import HistoryOfYouTubeDownloader from "@/app/components/Histories/HistoryOfYouTubeDownloader";
import FAQYouTubeDownloader from "@/app/components/Faqs/FaqYouTubeVideoDownloader";
...
export default function YouTubeVideoDownloader() {
  ...
  return (
    ...
    >
      ...
      >
        <HistoryOfYouTubeDownloader />
      </div>
      <FAQYouTubeDownloader />
    </div>
  );
}
