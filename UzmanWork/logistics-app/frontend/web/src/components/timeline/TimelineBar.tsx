...
import { TimelineBarSelectors } from "reducers/timeline_bar";
import { StyledTimelineBarButton } from "components/styled_components/StyledTimelineBarButton";
    ...
    >
      <Stack alignItems="center" gap="1.25rem">
        <LimitedUserRequired>
          ...
          >
            <StyledTimelineBarButton
              isSelected={timelineBarSelectors.showSearch}
            >
              <SearchIcon2
        ...
        <LimitedUserRequired>
          ...
          >
            <StyledTimelineBarButton
              isSelected={timelineBarSelectors.showAlert}
            >
              <NotificationIcon
          ...
          <DrawerItem
            onClick={() => {
              if (isLiveStream) {
                setNotificationData({
                  message:
                    "Journey not supported in live mode! Select a timestamp to enable Journey.",
                  severity: "warning",
                });
                return;
              }
        ...
        <LimitedUserRequired>
          ...
          >
            ...
            >
              <AnalyticsIcon
                color={
                  timelineBarSelectors.showAnalyticsControls
                    ? "#FFFF"
                    : "#3C3E49"
                }
              />
