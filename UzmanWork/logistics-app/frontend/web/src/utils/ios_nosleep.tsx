// from https://github.com/z-x/pushu.ps/blob/master/src/Helpers/noSleep.js

const VIDEO_DATA_WEBM =
...
export class IosNoSleep {
  ...
  constructor() {
    ...
    this._addSourceToVideo(this.noSleepVideo, "webm", VIDEO_DATA_WEBM);
    this._addSourceToVideo(this.noSleepVideo, "mp4", VIDEO_DATA_MP4);
