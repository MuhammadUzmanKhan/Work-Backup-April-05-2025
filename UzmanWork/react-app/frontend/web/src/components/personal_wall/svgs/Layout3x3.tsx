...
export function Layout3x3({ color, width }: LayoutSVGProps) {
  return (
    <Box sx={{ width: width }}>
      <svg
        width="20"
      ...
      >
        <rect width="6" height="6" rx="1" fill={color} />
        <rect x="7" width="6" height="6" rx="1" fill={color} />
        <rect x="14" width="6" height="6" rx="1" fill={color} />
        <rect y="7" width="6" height="6" rx="1" fill={color} />
        <rect x="7" y="7" width="6" height="6" rx="1" fill={color} />
