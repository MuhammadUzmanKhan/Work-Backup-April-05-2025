...
import { APP_NAME, DOMAIN, SEO } from "@/app/constants";

export const metadata: Metadata = {
  title: `Spin the wheel`,
  description: 'Use the Spin the wheel on Toolchimp.io to choose from multiple options easily. Perfect for decision making, games, and more!',
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${DOMAIN}/img/spin-the-wheel.png`,
        width: 800,
        height: 600,
  ...
  twitter: {
    ...
    title: `Spin the wheel`,
    description: 'Use the Spin the wheel on Toolchimp.io to choose from multiple options easily. Perfect for decision making, games, and more!',
    images: `${DOMAIN}/img/spin-the-wheel.png`
  }
};
