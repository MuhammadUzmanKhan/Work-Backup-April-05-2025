...
export const metadata: Metadata = {
  title: `Flip a Coin`,
  description: 'Flip a virtual coin online with our easy-to-use coin toss simulator. Perfect for making quick decisions, playing games, or just for fun!',
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${DOMAIN}/img/flip-a-coin.png`,
        width: 800,
        height: 600,
        alt: 'Flip a Coin'
      }
  ...
  twitter: {
    ...
    title: `Flip a Coin`,
    description: 'Flip a virtual coin online with our easy-to-use coin toss simulator. Perfect for making quick decisions, playing games, or just for fun!',
    images: `${DOMAIN}/img/flip-a-coin.png`
  }
};
