...
import { DashboardTopFilterRequiredDto } from '@Common/dto';

export class CommonFiltersDto extends IntersectionType(
  DashboardTopFilterRequiredDto,
  RegionIdDto,
) {
  @ApiPropertyOptional({
    description:
...
export class IncidentsByTypeDto extends IntersectionType(
  CommonFiltersDto,
  PaginationDto,
) {}

export class IncidentsByTypeMobileDto extends CommonFiltersDto {}
