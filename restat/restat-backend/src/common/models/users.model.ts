...
import { STRING, INTEGER, BOOLEAN, DATE } from 'sequelize';
import { Column, Model, Table, PrimaryKey, IsEmail, HasOne, ForeignKey, HasMany, BelongsTo, AllowNull } from 'sequelize-typescript';
...
export class Users extends Model {
  ...
  @Column({ type: STRING, defaultValue: ROLES.OWNER })
  role: ROLES;
